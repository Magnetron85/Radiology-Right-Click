...
- Nodule Size Comparison and Sorting

## Status
This project is currently in testing and development. We are aware of several areas for improvement:
- Global variables need to be cleaned up for better code organization
...
## Usage
Right-click on selected text in supported applications (e.g., radiology reporting software) to access the calculation menu.
