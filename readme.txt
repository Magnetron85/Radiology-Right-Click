...
Pathway #1: 
1.) Download the .exe file from GitHub. Download OCR dependcy (https://github.com/iseahound/Vis2). Place in same directory.
...
2) Download script fron GitHub on the same PC you installed AutoHotKey v 1.1. Download OCR dependency (https://github.com/iseahound/Vis2). Place OCR dependcy files in same directory as this script.
3) Compile script. 
2a) Optional: Place the generated exe file on a usb stick to transfer to PACS workstation. Place dependency folders in same directory on usb stick.
